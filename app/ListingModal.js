...
import {
  ...
  DollarSign, Phone, Mail, Calendar,
} from 'lucide-react'
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'relative', height: '260px', flexShrink: 0 }}>
          ...
          {user && (
            <div style={{
              ...
              <button
                onClick={() => { onToggleSaved(listing.id); if (onXP) onXP('SAVE_LISTING') }}
                style={{
                  display: 'flex', alignItems: 'center', gap: '6px',
                  padding: '6px 14px', borderRadius: '20px',
                  background: isSaved ? t.accent : 'rgba(0,0,0,0.6)',
                  border: `1px solid ${isSaved ? t.accent : 'rgba(255,255,255,0.3)'}`,
              ...
              <button
                onClick={() => { if (onXP) onXP('SHARE_LISTING') }}
                style={{
                  width: '34px', height: '34px', borderRadius: '50%',
              ...
              <button
                onClick={() => { onHide(listing.id); onClose() }}
                style={{
                  width: '34px', height: '34px', borderRadius: '50%',
                  background: 'rgba(0,0,0,0.6)',
                  border: '1px solid rgba(255,255,255,0.3)',
          ...
          {/* Price overlay */}
          <div style={{
            position: 'absolute', bottom: '14px', left: '16px', zIndex: 20,
            pointerEvents: 'none',
          }}>
            <p style={{
              color: '#fff', fontWeight: 900, fontSize: '28px', margin: 0,
        ...
        <div style={{
          ...
          flexShrink: 0, background: c.surface, overflowX: 'auto',
        }}>
          {tabs.map(tb => (
            <button
              key={tb.id}
              ...
              style={{
                ...
                color: tab === tb.id ? t.accent : c.textMuted,
              ...
              <div style={{
                ...
                {[
                  ...
                  <div key={label} style={{
                    ...
                    borderRadius: '12px', background: c.surfaceAlt,
            ...
            <div>
              <div style={{
                ...
                <div style={{
                  ...
                  boxShadow: `0 0 16px ${t.accentGlow}`, flexShrink: 0,
                }}>👤</div>
                <div>
