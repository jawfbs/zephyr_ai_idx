...
export default function ZephyrPage() {
  ...
  useEffect(() => { setUserStats(loadStats()) }, [])
                ...
                {user ? (
                  <>
                    ...
                    {accordionSections.map(section => (
                      <AccordionSection
                        key={section.label} section={section} c={c} t={t}
              ...
              {displayed.map(listing => {
                ...
                return (
                  <div key={listing.id}
                    ...
                    <div
                      style={{ position:'relative', flexShrink:0, width:viewMode==='list'?'220px':'100%' }}
